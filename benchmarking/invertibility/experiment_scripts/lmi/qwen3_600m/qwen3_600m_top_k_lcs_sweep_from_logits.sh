...
#LEARNABLE_LOGITS_ROOT="${LEARNABLE_LOGITS_ROOT:-results/qwen3-600m-base_STGS+Soft+LearnTau+SoftBPTT+LearnBTau+BS=16+LR=1e-1+SEED=2_test_k1-5-25-run/6jowjzns}"
LEARNABLE_LOGITS_ROOT="${LEARNABLE_LOGITS_ROOT:-results/qwen3-600m-base_STGS+Soft+LearnTau+SoftBPTT+LearnBTau+BS=16+LR=1e-1+SEED=2_test_k1-5-25-run/fqn3wmy0}"
...
TARGET_INDICES="${TARGET_INDICES:-0,1,2}"   # e.g. "0,1,5" ; empty means all dataset samples

TOP_K_VALUES="${TOP_K_VALUES:-1,2,4,16,32,128,1024,4096,16384,65536,131072}"
LOGITS_TOP_P="${LOGITS_TOP_P:-1.0}"
#OUTPUT_DIR="${OUTPUT_DIR:-results/qwen3-600m-base_top-k-lcs-sweep/1mkp9t21}"
#OUTPUT_DIR="${OUTPUT_DIR:-results/qwen3-600m-base_top-k-lcs-sweep/qqd01a5k}"
#OUTPUT_DIR="${OUTPUT_DIR:-results/qwen3-600m-base_top-k-lcs-sweep/6jowjzns}"
OUTPUT_DIR="${OUTPUT_DIR:-results/qwen3-600m-base_top-k-lcs-sweep/fqn3wmy0}"

WANDB_PROJECT="${WANDB_PROJECT:-LMI-GS-top-p-sweep}"
WANDB_ENTITY="${WANDB_ENTITY:-}"
WANDB_RUN_NAME="${WANDB_RUN_NAME:-qwen3_600m_top_k_lcs_sweep_from_logits}"
