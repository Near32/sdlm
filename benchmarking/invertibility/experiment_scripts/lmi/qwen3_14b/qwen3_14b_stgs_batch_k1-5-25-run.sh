...
--dataset_path="../../../data/qwen3-14b_diverse_targets_k1-5-25_x5_seed42_TL20_NF1" \
--output_dir="results/qwen3-14b_STGS+Soft+LearnTau+SoftBPTT+LearnBTau+BS=16+LR=1e-1+SEED=2_test_k1-5-25-run" \
