#!/bin/bash
# Generate GT prompt reconstruction random token dataset for SmolLM2-135M
...
for PROMPT_LENGTH in 10 20 80; do
    OUTPUT_PATH="${PARENT_DIR}/data/soda_smollm2-135m_random_SEED${SEED}_PL${PROMPT_LENGTH}_TL${OUTPUT_LENGTH}_N${NUM_SAMPLES}.json"
...
echo "Done generating all random datasets for SmolLM2-135M"
