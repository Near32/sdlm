...
# O2P Training Script for SmolLM2-135M
#
# This script trains a T5-based inverse model for prompt reconstruction
# on the SmolLM2-135M subject LLM.
#
# After training, use smollm2_135m_o2p_batch_k1-5-25-run.sh for evaluation.
...
# - batch_size: Adjust based on GPU memory (80 works well for 24GB GPU)
# - llm_precision: Use half to save memory (LLM is frozen anyway)
# - Output will be saved to ./o2p_checkpoints/smollm2-135m/best_model
