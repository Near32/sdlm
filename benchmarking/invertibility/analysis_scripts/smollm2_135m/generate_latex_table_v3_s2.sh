#!/bin/bash
# Generate LaTeX tables with v3 sub-row layout for SmolLM2-135M.
...
DATASET="${PARENT_DIR}/data/smollm2-135m-base_diverse_targets_k1-5-25_x5_seed42_TL20_NF1"

# W&B run ID (format: entity/project/runs/run_id or entity/project/run_id)
WANDB_ID="/near32/PromptOptimisationSTGS/runs/pbshhmij"

# HuggingFace model for perplexity computation
MODEL="HuggingFaceTB/SmolLM2-135M"

# Output file (leave empty for stdout)
OUTPUT="${PARENT_DIR}/results-SmolLM2-135M/table_qual_v3_s2.tex"

# Table settings
CAPTION="Qualitative optimization results for SmolLM2-135M ;"
